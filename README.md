...
поступающих точек плоскости и вычисляющую её периметр, площадь и мощность множества пересечения отрезка, заданного двумя произвольными точками, и границы оболочки. Решение
